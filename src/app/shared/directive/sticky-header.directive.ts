import { Directive, AfterViewInit, ElementRef, HostBinding, HostListener, Inject, Input, isDevMode, OnDestroy, OnInit, PLATFORM_ID } from '@angular/core';
import { isPlatformBrowser } from '@angular/common';
import { BehaviorSubject, Observable, Subject } from 'rxjs';
import { animationFrame } from 'rxjs/scheduler/animationFrame';
import { combineLatest } from 'rxjs/observable/combineLatest';
import { filter, map, share, startWith, takeUntil, throttleTime, debounceTime } from 'rxjs/operators';
...
export class StickyHeaderDirective implements OnInit, AfterViewInit, OnDestroy {
  filterGate = false;
  ...
  getComputedStyle(el: HTMLElement): ClientRect {
  ...
  private makeSticky(boundaryReached: boolean = false, marginTop: number, marginBottom: number): void {
    ...
    this.stickyElement.nativeElement.style.top = 55 + 'px';
