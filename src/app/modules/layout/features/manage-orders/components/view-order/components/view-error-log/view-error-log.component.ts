...
@Component({
  ...
  styleUrls: ['./view-error-log.component.scss']
})
export class ViewErrorLogComponent implements OnInit {
  ...
  public detailsToBeDisplayed = [{ label: this.translate.instant('orderId'), key: 'orderId', value: '' }, { label: this.translate.instant('customerId'), key: 'customerId', value: '' }, { label: this.translate.instant('supplier'), key: 'supplier', value: '' },
